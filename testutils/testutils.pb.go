...
const file_testutils_proto_rawDesc = "" +
	"\n" +
	"\x0ftestutils.proto\x12\ttestutils\"S\n" +
	"\fLaggyMessage\x12\x16\n" +
	"\x06origin\x18\x01 \x01(\tR\x06origin\x12\x17\n" +
	"\asent_at\x18\x02 \x01(\x03R\x06sentAt\x12\x12\n" +
	"\x04body\x18\x03 \x01(\fR\x04bodyB,Z*github.com/vibtreeofficial/psrpc/testutilsb\x06proto3"

var (
	file_testutils_proto_rawDescOnce sync.Once
	file_testutils_proto_rawDescData []byte
)

func file_testutils_proto_rawDescGZIP() []byte {
	file_testutils_proto_rawDescOnce.Do(func() {
		file_testutils_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_testutils_proto_rawDesc), len(file_testutils_proto_rawDesc)))
	})
	return file_testutils_proto_rawDescData
}

var file_testutils_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_testutils_proto_goTypes = []any{
...
func file_testutils_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_testutils_proto_rawDesc), len(file_testutils_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
