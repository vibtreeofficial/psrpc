...
import (
	...
	"github.com/vibtreeofficial/psrpc/protoc-gen-psrpc/internal/gen"
	"github.com/vibtreeofficial/psrpc/protoc-gen-psrpc/internal/gen/stringutils"
	"github.com/vibtreeofficial/psrpc/protoc-gen-psrpc/internal/gen/typemap"
	"github.com/vibtreeofficial/psrpc/protoc-gen-psrpc/options"
...
func (t *psrpc) generateImports(file *descriptor.FileDescriptorProto) {
	...
	// dependency imports
	t.P(`  "github.com/vibtreeofficial/psrpc"`)
	t.P(`  "github.com/vibtreeofficial/psrpc/pkg/client"`)
	t.P(`  "github.com/vibtreeofficial/psrpc/pkg/info"`)
	t.P(`  "github.com/vibtreeofficial/psrpc/pkg/rand"`)
	t.P(`  "github.com/vibtreeofficial/psrpc/pkg/server"`)
	t.P(`  "github.com/vibtreeofficial/psrpc/version"`)
	t.P(`)`)
