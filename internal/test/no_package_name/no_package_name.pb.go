...
const file_no_package_name_proto_rawDesc = "" +
	"\n" +
	"\x15no_package_name.proto\"\x05\n" +
	"\x03Msg2\x19\n" +
	"\x03Svc\x12\x12\n" +
	"\x04Send\x12\x04.Msg\x1a\x04.MsgB@Z>github.com/vibtreeofficial/psrpc/internal/test/no_package_nameb\x06proto3"

var (
	file_no_package_name_proto_rawDescOnce sync.Once
	file_no_package_name_proto_rawDescData []byte
)

func file_no_package_name_proto_rawDescGZIP() []byte {
	file_no_package_name_proto_rawDescOnce.Do(func() {
		file_no_package_name_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_no_package_name_proto_rawDesc), len(file_no_package_name_proto_rawDesc)))
	})
	return file_no_package_name_proto_rawDescData
}

var file_no_package_name_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_no_package_name_proto_goTypes = []any{
	(*Msg)(nil), // 0: Msg
}
...
func file_no_package_name_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_no_package_name_proto_rawDesc), len(file_no_package_name_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
