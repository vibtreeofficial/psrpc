...
const file_y_y_proto_rawDesc = "" +
	"\n" +
	"\ty/y.proto\x12#psrpc.internal.test.importmapping.y\"\x06\n" +
	"\x04MsgYB\x1fZ\x1dexample.com/will/be/ignored/yb\x06proto3"

var (
	file_y_y_proto_rawDescOnce sync.Once
	file_y_y_proto_rawDescData []byte
)

func file_y_y_proto_rawDescGZIP() []byte {
	file_y_y_proto_rawDescOnce.Do(func() {
		file_y_y_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_y_y_proto_rawDesc), len(file_y_y_proto_rawDesc)))
	})
	return file_y_y_proto_rawDescData
}

var file_y_y_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_y_y_proto_goTypes = []any{
	(*MsgY)(nil), // 0: psrpc.internal.test.importmapping.y.MsgY
}
...
func file_y_y_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_y_y_proto_rawDesc), len(file_y_y_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
