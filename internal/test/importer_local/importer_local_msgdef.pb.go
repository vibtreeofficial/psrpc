...
const file_importer_local_msgdef_proto_rawDesc = "" +
	"\n" +
	"\x1bimporter_local_msgdef.proto\x12\"psrpc.internal.test.importer_local\"\x05\n" +
	"\x03MsgB?Z=github.com/vibtreeofficial/psrpc/internal/test/importer_localb\x06proto3"

var (
	file_importer_local_msgdef_proto_rawDescOnce sync.Once
	file_importer_local_msgdef_proto_rawDescData []byte
)

func file_importer_local_msgdef_proto_rawDescGZIP() []byte {
	file_importer_local_msgdef_proto_rawDescOnce.Do(func() {
		file_importer_local_msgdef_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_importer_local_msgdef_proto_rawDesc), len(file_importer_local_msgdef_proto_rawDesc)))
	})
...
var file_importer_local_msgdef_proto_goTypes = []any{
...
func file_importer_local_msgdef_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_importer_local_msgdef_proto_rawDesc), len(file_importer_local_msgdef_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
