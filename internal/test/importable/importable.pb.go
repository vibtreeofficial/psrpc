...
const file_importable_proto_rawDesc = "" +
	"\n" +
	"\x10importable.proto\x12\x1epsrpc.internal.test.importable\"\x05\n" +
	"\x03Msg2W\n" +
	"\x03Svc\x12P\n" +
	"\x04Send\x12#.psrpc.internal.test.importable.Msg\x1a#.psrpc.internal.test.importable.MsgB;Z9github.com/vibtreeofficial/psrpc/internal/test/importableb\x06proto3"
