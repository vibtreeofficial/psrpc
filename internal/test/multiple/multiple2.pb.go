...
const file_multiple2_proto_rawDesc = "" +
	"\n" +
	"\x0fmultiple2.proto\x12\x1cpsrpc.internal.test.multiple\x1a\x0fmultiple1.proto\"\x06\n" +
	"\x04Msg22\xb8\x01\n" +
	"\x04Svc2\x12N\n" +
	"\x04Send\x12\".psrpc.internal.test.multiple.Msg2\x1a\".psrpc.internal.test.multiple.Msg2\x12`\n" +
	"\x16SamePackageProtoImport\x12\".psrpc.internal.test.multiple.Msg1\x1a\".psrpc.internal.test.multiple.Msg1B\vZ\t/multipleb\x06proto3"

var (
	file_multiple2_proto_rawDescOnce sync.Once
	file_multiple2_proto_rawDescData []byte
)

func file_multiple2_proto_rawDescGZIP() []byte {
	file_multiple2_proto_rawDescOnce.Do(func() {
		file_multiple2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_multiple2_proto_rawDesc), len(file_multiple2_proto_rawDesc)))
	})
	return file_multiple2_proto_rawDescData
}

var file_multiple2_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_multiple2_proto_goTypes = []any{
...
func file_multiple2_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_multiple2_proto_rawDesc), len(file_multiple2_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
