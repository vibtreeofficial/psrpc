...
const file_multiple1_proto_rawDesc = "" +
	"\n" +
	"\x0fmultiple1.proto\x12\x1cpsrpc.internal.test.multiple\"\x06\n" +
	"\x04Msg12V\n" +
	"\x04Svc1\x12N\n" +
	"\x04Send\x12\".psrpc.internal.test.multiple.Msg1\x1a\".psrpc.internal.test.multiple.Msg1B\vZ\t/multipleb\x06proto3"

var (
	file_multiple1_proto_rawDescOnce sync.Once
	file_multiple1_proto_rawDescData []byte
)

func file_multiple1_proto_rawDescGZIP() []byte {
	file_multiple1_proto_rawDescOnce.Do(func() {
		file_multiple1_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_multiple1_proto_rawDesc), len(file_multiple1_proto_rawDesc)))
	})
	return file_multiple1_proto_rawDescData
}

var file_multiple1_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_multiple1_proto_goTypes = []any{
...
func file_multiple1_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_multiple1_proto_rawDesc), len(file_multiple1_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
