...
const file_empty_service_proto_rawDesc = "" +
	"\n" +
	"\x13empty_service.proto\x12 psrpc.internal.test.emptyservice2\a\n" +
	"\x05EmptyB\x10Z\x0e/empty_serviceb\x06proto3"

var file_empty_service_proto_goTypes = []any{}
...
func file_empty_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_empty_service_proto_rawDesc), len(file_empty_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
